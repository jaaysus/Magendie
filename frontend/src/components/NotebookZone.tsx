...
const NotebookZone: React.FC<NotebookZoneProps> = ({
  ...
  return (
    <div id="notebook-zone">
      <div className="notebook-header">📝 {currentExperiment === 'magendie' ? 'Carnet Scientifique' : 'Carnet de Notes'}</div>
      <div className="notebook-content">
        {currentExperiment === 'magendie' ? (
          ...
          <div className="status-box">
            <h3>Notes pour {currentExperiment}</h3>
            <p>Le carnet pour cette expérience est en cours de développement.</p>
          </div>
        )}
